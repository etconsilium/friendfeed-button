/**
 * Created by vs on 24.06.14.
 * @author friendfeed.com team
 * @author @falsefalse, source https://gist.github.com/falsefalse/dc7bb726add8b19a741c/#file-share-js
 * @author @etconsilium github.com/etconsilium
 */
(function() {
...
//            image = image.previousSibling;
    ...
    function close(args) {
        ...
        foreground.innerHTML = '<img style="width:16px;height:16px;margin-bottom:-3px;margin-right:1px" src="'+chrome.extension.getURL('/internal.png')+'"> ' + message + ' <a href="#" id="ff__close" style="margin-left:1em;color:#1030cc">' + 'close' + '</a>';
    ...
    if (document.getElementsByTagName('head').length == 0 ||
        ...
        window.location.href = window.location.protocol+'friendfeed.com/?link=' + encodeURIComponent(window.location.href);
    } else {
        bookmarklet();
    }
})();